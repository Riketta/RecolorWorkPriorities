...
[*]Moves the low-skill warning border one tier up too: work boxes of active work at skill 3 and below are highlighted (vanilla: 2 and below). The threshold is a slider and the tooltip warning follows it, wearing the same tier color as vanilla's design.[/list]
